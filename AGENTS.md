...
Current checkpoint: 7. Checkpoints 1–6 are implemented and tested; container startup, HTTPS sessions across restarts, backup restoration, database-outage responses, and compatible application rollback pass in CI. Learning review remains deferred to questions.md; do not mark it complete without evidence. Public deployment requires the Mac mini connection and hostname/tunnel configuration recorded there.
