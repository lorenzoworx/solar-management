...
Current checkpoint: 7. Public app: https://boywithabot.com/projects/solar-management/. All eight public browser scenarios passed on September 20, 2026, including registration, installation CRUD, readings, alert resolution, logout, and login. The prior HTTPS registration blocker is resolved after owner-reported deployment changes; the exact proxy configuration was not inspected. Container recovery passes in CI; on-host recovery and release tagging remain. The owner handles Mac mini operations. Support APP_BASE_PATH at build time and retain HTTPS checks. Learning review remains deferred to the local, Git-ignored questions.md; do not commit that file or mark review complete without evidence.
